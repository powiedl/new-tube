...
export const playlistsRouter = createTRPCRouter({
  ...
  getVideos: protectedProcedure
    ...
    .query(async ({ ctx, input }) => {
      ...
      // You are only allowed to get/read your own playlists
  ...
  removeVideo: protectedProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      if (existingPlaylist.userId !== userId) {
        ...
        // alternative approach - check the userId in the where clause, but in that case you can not distinguish between a not existing playlist and a foreign playlist
      }
