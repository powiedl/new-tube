...
export const PlaylistThumbnail = ({
  ...
  return (
    <div className={cn('relative p5-3', className)}>
      {/* Stack effect layers */}
      ...
      <div className='absolute bottom-2 right-2 px-1 py-0 5 bl-black/80 text-white text-xs font-medium flex items-center gap-x-1'>
